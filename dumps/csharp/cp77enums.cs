...
namespace WolvenKit.RED4.CR2W.Types
{
	public static partial class Enums
	{
		...
		public enum gameStubMappinType
		{
			None = 0,
			Police = 1,
			PoliceVehicle = 2,
		...
		public enum inputESimplifiedInputDevice
		{
			KBM = 0,
			PAD = 1
		}
		...
		public enum minimapuiELayerType
		{
			Floor = 0,
			Cover = 1,
			WallInterior = 2,
		...
		public enum servicesCloudSavesQueryStatus
		{
			NotFetched = 0,
		...
		public enum vehiclePoliceStrategy
		{
			None = 0,
