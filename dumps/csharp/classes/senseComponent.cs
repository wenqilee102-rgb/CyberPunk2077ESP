...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class senseComponent : entIPlacedComponent
	{
		...
		private CBool _enabledSenses;
		private CBool _shouldStartDetectingPlayerCached;
		private CBool _wasPlayerLastReactionTarget;
		private CEnum<ESenseLogSource> _logSource;
		...
		{
			get => GetProperty(ref _forceDisableUI);
			set => SetProperty(ref _forceDisableUI, value);
		}
		...
		{
			get => GetProperty(ref _wantedLevelChangedCb);
			set => SetProperty(ref _wantedLevelChangedCb, value);
		}
		...
		{
			get => GetProperty(ref _enabledSenses);
			set => SetProperty(ref _enabledSenses, value);
		}
		...
		{
			get => GetProperty(ref _shouldStartDetectingPlayerCached);
			set => SetProperty(ref _shouldStartDetectingPlayerCached, value);
		}
		...
		{
			get => GetProperty(ref _wasPlayerLastReactionTarget);
			set => SetProperty(ref _wasPlayerLastReactionTarget, value);
		}
