...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkanimPlaybackOptions : CVariable
	{
		...
		private CBool _applyCustomTimeDilation;
		private CFloat _customTimeDilation;
		...
		{
			get => GetProperty(ref _applyCustomTimeDilation);
			set => SetProperty(ref _applyCustomTimeDilation, value);
		}
		...
		{
			get => GetProperty(ref _customTimeDilation);
			set => SetProperty(ref _customTimeDilation, value);
		}
