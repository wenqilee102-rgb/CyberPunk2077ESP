...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkScrollController : inkWidgetLogicController
	{
		...
		private CFloat _desiredSetupPosition;
		private CBool _contentSmallerThanViewport;
		...
		{
			get => GetProperty(ref _desiredSetupPosition);
			set => SetProperty(ref _desiredSetupPosition, value);
		}
		...
		{
			get => GetProperty(ref _contentSmallerThanViewport);
			set => SetProperty(ref _contentSmallerThanViewport, value);
		}
