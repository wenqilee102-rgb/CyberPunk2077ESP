...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class physicsCollisionFilterResource : ISerializable
	{
		...
		private rRef<JsonResource> _queryPresetJson;
		...
		[Ordinal(2)] 
		[RED("queryPresetJson")] 
		public rRef<JsonResource> QueryPresetJson
		{
			get => GetProperty(ref _queryPresetJson);
			set => SetProperty(ref _queryPresetJson, value);
		}
