...
{
	[REDMeta]
	public class IsMountedByPreventionNPCPrereqState : gamePrereqState
	{
		...
		public IsMountedByPreventionNPCPrereqState(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
