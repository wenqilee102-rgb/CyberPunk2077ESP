...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class PuppetDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Bool _isPlayerInterestingFromSecuritySystemPOV;
		...
		{
			get => GetProperty(ref _isPlayerInterestingFromSecuritySystemPOV);
			set => SetProperty(ref _isPlayerInterestingFromSecuritySystemPOV, value);
		}
