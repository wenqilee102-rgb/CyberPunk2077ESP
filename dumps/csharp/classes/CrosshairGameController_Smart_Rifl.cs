...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class CrosshairGameController_Smart_Rifl : gameuiCrosshairBaseGameController
	{
		...
		private CBool _hasSmartLink;
		private wCHandle<gameIBlackboard> _weaponBlackboard;
		private CHandle<redCallbackObject> _weaponParamsListenerId;
		private CHandle<gamesmartGunUIParameters> _smartData;
		private CArray<wCHandle<inkWidget>> _targetsPool;
		...
		private CArray<entEntityID> _currTargetedEntityIDs;
		private CInt32 _numLockedTargets;
		...
		{
			get => GetProperty(ref _hasSmartLink);
			set => SetProperty(ref _hasSmartLink, value);
		}
		...
		{
			get => GetProperty(ref _smartData);
			set => SetProperty(ref _smartData, value);
		}

		[Ordinal(62)] 
		[RED("targetsPool")] 
		public CArray<wCHandle<inkWidget>> TargetsPool
		{
			get => GetProperty(ref _targetsPool);
			set => SetProperty(ref _targetsPool, value);
		}
		...
		{
			get => GetProperty(ref _currTargetedEntityIDs);
			set => SetProperty(ref _currTargetedEntityIDs, value);
		}
		...
		{
			get => GetProperty(ref _numLockedTargets);
			set => SetProperty(ref _numLockedTargets, value);
		}
