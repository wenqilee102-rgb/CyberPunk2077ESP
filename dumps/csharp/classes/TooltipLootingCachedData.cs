...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TooltipLootingCachedData : IScriptable
	{
		...
		private CHandle<UIInventoryItemWeaponBars> _comparisonWeaponBars;
		...
		{
			get => GetProperty(ref _comparisonWeaponBars);
			set => SetProperty(ref _comparisonWeaponBars, value);
		}
