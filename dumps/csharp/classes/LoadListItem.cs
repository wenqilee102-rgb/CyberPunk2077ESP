...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class LoadListItem : AnimatedListItemController
	{
		...
		private CHandle<inkSaveMetadataInfo> _metadata;
		private redResourceReferenceScriptToken _defaultAtlasPath;
		private CHandle<inkanimProxy> _tranistionAnimProxy;
		...
		{
			get => GetProperty(ref _tranistionAnimProxy);
			set => SetProperty(ref _tranistionAnimProxy, value);
		}
