...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class UI_ItemModSystemDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Bool _itemModSystemUpgradingInProgress;
		...
		{
			get => GetProperty(ref _itemModSystemUpgradingInProgress);
			set => SetProperty(ref _itemModSystemUpgradingInProgress, value);
		}
