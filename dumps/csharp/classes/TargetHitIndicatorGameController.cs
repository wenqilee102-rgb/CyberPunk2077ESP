...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TargetHitIndicatorGameController : gameuiWidgetGameController
	{
		...
		private CHandle<gameAttachmentSlotsScriptListener> _weaponChangedListener;
		...
		{
			get => GetProperty(ref _weaponChangedListener);
			set => SetProperty(ref _weaponChangedListener, value);
		}
