...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class entLODDefinition : ISerializable
	{
		...
		private CStatic<CFloat> _vehicleDecorationDistanceLODs;
		...
		{
			get => GetProperty(ref _vehicleDecorationDistanceLODs);
			set => SetProperty(ref _vehicleDecorationDistanceLODs, value);
		}
