...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class IMaterialDefinition : IMaterial
	{
		...
		private CBool _canBeMasked;
		private CEnum<EMaterialShadingRateMode> _shadingRateMode;
		...
		{
			get => GetProperty(ref _canBeMasked);
			set => SetProperty(ref _canBeMasked, value);
		}
		...
		{
			get => GetProperty(ref _shadingRateMode);
			set => SetProperty(ref _shadingRateMode, value);
		}
