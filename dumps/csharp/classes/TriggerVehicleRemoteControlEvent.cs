...
{
	[REDMeta]
	public class TriggerVehicleRemoteControlEvent : redEvent
	{
		...
		public TriggerVehicleRemoteControlEvent(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
