...
{
	[REDMeta]
	public class gameeventsStartFinisherEvent : redEvent
	{
		...
		public gameeventsStartFinisherEvent(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
