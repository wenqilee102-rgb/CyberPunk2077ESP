...
{
	[REDMeta]
	public class gamestateMachineeventResetStateMachine : redEvent
	{
		...
		public gamestateMachineeventResetStateMachine(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
