...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class IronsightGameController : gameuiIronsightGameController
	{
		...
		private CName _firstEquipAnimationName;
		...
		private wCHandle<gameweaponObject> _originalWeapon;
		...
		{
			get => GetProperty(ref _firstEquipAnimationName);
			set => SetProperty(ref _firstEquipAnimationName, value);
		}
		...
		[Ordinal(26)] 
		[RED("originalWeapon")] 
		public wCHandle<gameweaponObject> OriginalWeapon
		{
			get => GetProperty(ref _originalWeapon);
			set => SetProperty(ref _originalWeapon, value);
		}
