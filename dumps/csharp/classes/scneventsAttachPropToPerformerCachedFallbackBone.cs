...
{
	[REDMeta]
	public class scneventsAttachPropToPerformerCachedFallbackBone : CVariable
	{
		...
		public scneventsAttachPropToPerformerCachedFallbackBone(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
