...
{
	[REDMeta]
	public class ShouldContinuePatrolFromNextControlPoint : AIbehaviorconditionScript
	{
		...
		public ShouldContinuePatrolFromNextControlPoint(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
