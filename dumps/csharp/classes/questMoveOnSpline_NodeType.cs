...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class questMoveOnSpline_NodeType : questIVehicleManagerNodeType
	{
		...
		private CEnum<vehicleAIPathTrafficDeletionMode> _trafficDeletionMode;
		...
		{
			get => GetProperty(ref _trafficDeletionMode);
			set => SetProperty(ref _trafficDeletionMode, value);
		}
