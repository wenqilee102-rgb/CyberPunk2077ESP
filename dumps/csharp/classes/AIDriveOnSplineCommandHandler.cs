...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIDriveOnSplineCommandHandler : AICommandHandlerBase
	{
		...
		private CHandle<AIArgumentMapping> _outRubberBandingTargetForwardOffset;
		...
		private CHandle<AIArgumentMapping> _outAudioCurvesParam;
		...
		{
			get => GetProperty(ref _outRubberBandingTargetForwardOffset);
			set => SetProperty(ref _outRubberBandingTargetForwardOffset, value);
		}
		...
		{
			get => GetProperty(ref _outAudioCurvesParam);
			set => SetProperty(ref _outAudioCurvesParam, value);
		}
