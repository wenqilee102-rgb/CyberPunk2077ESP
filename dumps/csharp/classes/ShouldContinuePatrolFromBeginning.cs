...
{
	[REDMeta]
	public class ShouldContinuePatrolFromBeginning : AIbehaviorconditionScript
	{
		...
		public ShouldContinuePatrolFromBeginning(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
