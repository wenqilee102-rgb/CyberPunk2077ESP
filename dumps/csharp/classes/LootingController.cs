...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class LootingController : inkWidgetLogicController
	{
		...
		private entEntityID _boundOwnerID;
		private CArray<wCHandle<gameItemData>> _lootingItems;
		private CArray<CHandle<UIInventoryItem>> _uiInventoryItems;
		private wCHandle<TooltipProvider> _tooltipProvider;
		private CHandle<ATooltipData> _cachedTooltipData;
		private CHandle<UIInventoryItem> _cachedTooltipUIInventoryItem;
		...
		{
			get => GetProperty(ref _boundOwnerID);
			set => SetProperty(ref _boundOwnerID, value);
		}

		[Ordinal(19)] 
		[RED("lootingItems")] 
		public CArray<wCHandle<gameItemData>> LootingItems
		{
			get => GetProperty(ref _lootingItems);
			set => SetProperty(ref _lootingItems, value);
		}
		...
		{
			get => GetProperty(ref _uiInventoryItems);
			set => SetProperty(ref _uiInventoryItems, value);
		}
		...
		{
			get => GetProperty(ref _cachedTooltipUIInventoryItem);
			set => SetProperty(ref _cachedTooltipUIInventoryItem, value);
		}
		...
		{
			get => GetProperty(ref _activeWeaponID);
			set => SetProperty(ref _activeWeaponID, value);
		}
		...
		{
			get => GetProperty(ref _brokenLocPrefix);
			set => SetProperty(ref _brokenLocPrefix, value);
		}
