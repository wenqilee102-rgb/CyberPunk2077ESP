...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIShootingDataDef : AIBlackboardDef
	{
		...
		private gamebbScriptID_Float _pauseConditionCheckTimeStamp;
		private gamebbScriptID_Float _lastChargeLevel;
		...
		private gamebbScriptID_Bool _shootingFromCar;
		...
		{
			get => GetProperty(ref _pauseConditionCheckTimeStamp);
			set => SetProperty(ref _pauseConditionCheckTimeStamp, value);
		}
		...
		{
			get => GetProperty(ref _lastChargeLevel);
			set => SetProperty(ref _lastChargeLevel, value);
		}
		...
		{
			get => GetProperty(ref _shootingFromCar);
			set => SetProperty(ref _shootingFromCar, value);
		}
