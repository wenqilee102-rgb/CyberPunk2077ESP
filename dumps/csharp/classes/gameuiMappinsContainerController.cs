...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiMappinsContainerController : gameuiProjectedHUDGameController
	{
		...
		private inkLinePatternWidgetReference _gpsDelamainPathWidget;
		private inkLinePatternWidgetReference _autodrivePathWidget;
		...
		{
			get => GetProperty(ref _gpsDelamainPathWidget);
			set => SetProperty(ref _gpsDelamainPathWidget, value);
		}
		...
		{
			get => GetProperty(ref _autodrivePathWidget);
			set => SetProperty(ref _autodrivePathWidget, value);
		}
