...
{
	[REDMeta]
	public class RadialMenuItemController : inkWidgetLogicController
	{
		...
		private CBool _queueHoverEvents;
		private CBool _disableClick;
		private CBool _applyHoverState;
		...
		{
			get => GetProperty(ref _queueHoverEvents);
			set => SetProperty(ref _queueHoverEvents, value);
		}
		...
		{
			get => GetProperty(ref _disableClick);
		...
		{
			get => GetProperty(ref _applyHoverState);
			set => SetProperty(ref _applyHoverState, value);
		}
		...
		public RadialMenuItemController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
