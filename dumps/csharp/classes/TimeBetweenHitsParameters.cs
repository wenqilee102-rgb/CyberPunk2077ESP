...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TimeBetweenHitsParameters : CVariable
	{
		...
		private CFloat _coverCoefficient;
		private CFloat _visionBlockerCoefficient;
		...
		{
			get => GetProperty(ref _coverCoefficient);
			set => SetProperty(ref _coverCoefficient, value);
		}
		...
		{
			get => GetProperty(ref _visionBlockerCoefficient);
			set => SetProperty(ref _visionBlockerCoefficient, value);
		}
