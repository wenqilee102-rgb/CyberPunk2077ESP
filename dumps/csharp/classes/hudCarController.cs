...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class hudCarController : gameuiHUDGameController
	{
		...
		private inkTextWidgetReference _speedUnits;
		...
		{
			get => GetProperty(ref _speedUnits);
		...
		public CBool KmOn
		{
			get => GetProperty(ref _kmOn);
			set => SetProperty(ref _kmOn, value);
		}
