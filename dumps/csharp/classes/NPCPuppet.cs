...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class NPCPuppet : ScriptedPuppet
	{
		...
		private CArray<wCHandle<NPCPuppet>> _ragdollImpactedNPCs;
		private CBool _disableRagdollAfterRecovery;
		private CArray<wCHandle<entEntity>> _thrownNPCNearbyCrowdNPCs;
		private CBool _isNotVisible;
		private CHandle<NPCDeathListener> _deathListener;
		private CHandle<NPCPoiseListener> _poiseListener;
		private CHandle<NPCGodModeListener> _godModeStatListener;
		private CUInt32 _vehicleHitImmunityCallbackID;
		...
		private CBool _shouldBeImmuneToVehicleHit;
		...
		private CBool _wasAggressiveCrowd;
		...
		private CBool _pendingDueToCachedSEAnim;
		...
		public CArray<wCHandle<NPCPuppet>> RagdollImpactedNPCs
		{
			get => GetProperty(ref _ragdollImpactedNPCs);
			set => SetProperty(ref _ragdollImpactedNPCs, value);
		}
		...
		public CArray<wCHandle<entEntity>> ThrownNPCNearbyCrowdNPCs
		{
			get => GetProperty(ref _thrownNPCNearbyCrowdNPCs);
			set => SetProperty(ref _thrownNPCNearbyCrowdNPCs, value);
		}
		...
		{
			get => GetProperty(ref _poiseListener);
			set => SetProperty(ref _poiseListener, value);
		}
		...
		{
			get => GetProperty(ref _vehicleHitImmunityCallbackID);
			set => SetProperty(ref _vehicleHitImmunityCallbackID, value);
		}
		...
		{
			get => GetProperty(ref _shouldBeImmuneToVehicleHit);
			set => SetProperty(ref _shouldBeImmuneToVehicleHit, value);
		}
		...
		{
			get => GetProperty(ref _wasAggressiveCrowd);
			set => SetProperty(ref _wasAggressiveCrowd, value);
		}
		...
		{
			get => GetProperty(ref _pendingDueToCachedSEAnim);
			set => SetProperty(ref _pendingDueToCachedSEAnim, value);
		}
