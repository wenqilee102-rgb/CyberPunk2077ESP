...
{
	[REDMeta]
	public class CheckElapsedTimeFromArgumentFloat : CheckArguments
	{
		...
		public CheckElapsedTimeFromArgumentFloat(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
