...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class DialogChoiceLogicController : inkWidgetLogicController
	{
		...
		private inkWidgetReference _tagWrapper;
		private inkWidgetReference _tagSeparator;
		private inkTextWidgetReference _tagTextRef;
		...
		{
			get => GetProperty(ref _tagWrapper);
			set => SetProperty(ref _tagWrapper, value);
		}
		...
		{
			get => GetProperty(ref _tagSeparator);
			set => SetProperty(ref _tagSeparator, value);
		}
		...
		{
			get => GetProperty(ref _tagTextRef);
			set => SetProperty(ref _tagTextRef, value);
		}
