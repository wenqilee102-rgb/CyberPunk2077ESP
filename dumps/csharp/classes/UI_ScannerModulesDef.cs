...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class UI_ScannerModulesDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Variant _scannerVehicleCustomization;
		...
		{
			get => GetProperty(ref _scannerVehicleCustomization);
			set => SetProperty(ref _scannerVehicleCustomization, value);
		}
