...
{
	[REDMeta]
	public class ShowTwintoneOverrideEvent : redEvent
	{
		...
		public ShowTwintoneOverrideEvent(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
