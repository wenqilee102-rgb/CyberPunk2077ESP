...
{
	[REDMeta]
	public class PlayVFXOnHitPositionEffector : gameEffector
	{
		...
		public PlayVFXOnHitPositionEffector(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
