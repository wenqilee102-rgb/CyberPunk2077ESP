...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class animAnimFeature_MeleeData : animAnimFeature
	{
		...
		private CBool _isThrowReloading;
		private CFloat _throwReloadTime;
		...
		{
			get => GetProperty(ref _isThrowReloading);
			set => SetProperty(ref _isThrowReloading, value);
		}
		...
		{
			get => GetProperty(ref _throwReloadTime);
			set => SetProperty(ref _throwReloadTime, value);
		}
