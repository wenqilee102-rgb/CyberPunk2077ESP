...
{
	[REDMeta]
	public class FindTeleportPositionForTakedown : AIbehaviorconditionScript
	{
		...
		public FindTeleportPositionForTakedown(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
