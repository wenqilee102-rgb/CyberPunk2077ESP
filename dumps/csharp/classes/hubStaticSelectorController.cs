...
{
	[REDMeta]
	public class hubStaticSelectorController : inkSelectorController
	{
		...
		public hubStaticSelectorController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
