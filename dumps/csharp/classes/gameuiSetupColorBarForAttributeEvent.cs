...
{
	[REDMeta]
	public class gameuiSetupColorBarForAttributeEvent : redEvent
	{
		...
		public gameuiSetupColorBarForAttributeEvent(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
