...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiCrosshairContainerController : gameuiHUDGameController
	{
		...
		private CHandle<redCallbackObject> _psmVehicleInTPPBlackboardId;
		...
		{
			get => GetProperty(ref _psmVehicleInTPPBlackboardId);
			set => SetProperty(ref _psmVehicleInTPPBlackboardId, value);
		}
