...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class SDeviceActionCustomData : SDeviceActionData
	{
		...
		private CBool _restrictInCombat;
		private CBool _restrictIfWanted;
		private CBool _restrictDuringPhonecall;
		...
		{
			get => GetProperty(ref _restrictInCombat);
			set => SetProperty(ref _restrictInCombat, value);
		}
		...
		{
			get => GetProperty(ref _restrictIfWanted);
			set => SetProperty(ref _restrictIfWanted, value);
		}
		...
		{
			get => GetProperty(ref _restrictDuringPhonecall);
			set => SetProperty(ref _restrictDuringPhonecall, value);
		}
