...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkImageWidget : inkLeafWidget
	{
		...
		private CFloat _horizontalTileCrop;
		private CFloat _verticalTileCrop;
		...
		{
			get => GetProperty(ref _horizontalTileCrop);
			set => SetProperty(ref _horizontalTileCrop, value);
		}
		...
		{
			get => GetProperty(ref _verticalTileCrop);
			set => SetProperty(ref _verticalTileCrop, value);
		}
