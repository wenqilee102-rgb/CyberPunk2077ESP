...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class HUDManager : gameNativeHudManager
	{
		...
		private CBool _uiQuickHackKeepContext;
		...
		private CHandle<redCallbackObject> _uiQuickhackKeepContextCallbackID;
		...
		{
			get => GetProperty(ref _uiQuickHackKeepContext);
			set => SetProperty(ref _uiQuickHackKeepContext, value);
		}
		...
		{
			get => GetProperty(ref _uiQuickhackKeepContextCallbackID);
			set => SetProperty(ref _uiQuickhackKeepContextCallbackID, value);
		}
