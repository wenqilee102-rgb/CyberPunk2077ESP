...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class WaterAreaSettings : IAreaSettings
	{
		...
		private curveData<CFloat> _windDir;
		private curveData<CFloat> _windSpeed;
		private curveData<CFloat> _windScale;
		private curveData<CFloat> _amplitude;
		private curveData<CFloat> _lambda;
		...
		[Ordinal(10)] 
		[RED("windDir")] 
		public curveData<CFloat> WindDir
		{
		...
		[Ordinal(11)] 
		[RED("windSpeed")] 
		public curveData<CFloat> WindSpeed
		{
		...
		[Ordinal(12)] 
		[RED("windScale")] 
		public curveData<CFloat> WindScale
		{
		...
		[Ordinal(13)] 
		[RED("amplitude")] 
		public curveData<CFloat> Amplitude
		{
		...
		[Ordinal(14)] 
		[RED("lambda")] 
		public curveData<CFloat> Lambda
		{
