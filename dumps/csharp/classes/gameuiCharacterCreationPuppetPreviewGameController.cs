...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiCharacterCreationPuppetPreviewGameController : gameuiPuppetPreviewGameController
	{
		...
		private wCHandle<gameuiICharacterCustomizationSystem> _characterCustomizationSystem;
		...
		public wCHandle<gameuiICharacterCustomizationSystem> CharacterCustomizationSystem
		{
			get => GetProperty(ref _characterCustomizationSystem);
			set => SetProperty(ref _characterCustomizationSystem, value);
		}
