...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class questQuestPhaseResource : graphGraphResource
	{
		...
		private CArray<rRef<CResource>> _inplacePhases;
		...
		[Ordinal(3)] 
		[RED("inplacePhases")] 
		public CArray<rRef<CResource>> InplacePhases
		{
			get => GetProperty(ref _inplacePhases);
			set => SetProperty(ref _inplacePhases, value);
		}
