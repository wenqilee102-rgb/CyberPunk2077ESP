...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class ScriptableDeviceComponentPS : SharedGameplayPS
	{
		...
		private CBool _isUnderEMPEffect;
		...
		{
			get => GetProperty(ref _isTimedTurnOff);
			set => SetProperty(ref _isTimedTurnOff, value);
		}
		...
		{
			get => GetProperty(ref _isUnderEMPEffect);
			set => SetProperty(ref _isUnderEMPEffect, value);
		}
