...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiHDRSettingsGameController : gameuiMenuGameController
	{
		...
		private CName _s_saturationGroup;
		...
		private inkCompoundWidgetReference _saturationOptionSelector;
		...
		{
			get => GetProperty(ref _s_saturationGroup);
			set => SetProperty(ref _s_saturationGroup, value);
		}
		...
		{
			get => GetProperty(ref _saturationOptionSelector);
			set => SetProperty(ref _saturationOptionSelector, value);
		}
