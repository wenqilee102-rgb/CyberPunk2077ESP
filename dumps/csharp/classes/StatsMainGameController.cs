...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class StatsMainGameController : gameuiMenuGameController
	{
		...
		private inkWidgetReference _rightPanelFluff1;
		private inkWidgetReference _rightPanelFluff2;
		...
		{
			get => GetProperty(ref _rightPanelFluff1);
			set => SetProperty(ref _rightPanelFluff1, value);
		}
		...
		{
			get => GetProperty(ref _rightPanelFluff2);
			set => SetProperty(ref _rightPanelFluff2, value);
		}
