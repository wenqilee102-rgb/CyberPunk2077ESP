...
{
	[REDMeta]
	public class FinisherLeapToTargetDecisions : FinisherTransition
	{
		...
		public FinisherLeapToTargetDecisions(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
