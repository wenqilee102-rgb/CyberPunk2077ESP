...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameprojectileHitInstance : CVariable
	{
		...
		private CBool _isWaterSurfaceImpact;
		private CBool _hitThroughWaterSurface;
		...
		{
			get => GetProperty(ref _isWaterSurfaceImpact);
			set => SetProperty(ref _isWaterSurfaceImpact, value);
		}
		...
		{
			get => GetProperty(ref _hitThroughWaterSurface);
			set => SetProperty(ref _hitThroughWaterSurface, value);
		}
