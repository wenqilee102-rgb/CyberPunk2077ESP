...
{
	[REDMeta]
	public class questMappinGPSComparison_ConditionType : questIDistanceConditionType
	{
		private CHandle<questMappinGPSDistance> _distanceDefinition1;
		...
		public questMappinGPSComparison_ConditionType(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
