...
{
	[REDMeta]
	public class gameInventoryItemAttachments : IScriptable
	{
		...
		public gameInventoryItemAttachments(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
