...
{
	[REDMeta]
	public class HealthbarMemoryStatListener : gameScriptStatsListener
	{
		...
		public HealthbarMemoryStatListener(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
