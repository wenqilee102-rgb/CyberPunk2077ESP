...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class ControlledDevicesInkGameController : gameuiWidgetGameController
	{
		...
		private wCHandle<inkHorizontalPanelWidget> _devicesStackSlot;
		...
		public wCHandle<inkHorizontalPanelWidget> DevicesStackSlot
		{
			get => GetProperty(ref _devicesStackSlot);
			set => SetProperty(ref _devicesStackSlot, value);
		}
