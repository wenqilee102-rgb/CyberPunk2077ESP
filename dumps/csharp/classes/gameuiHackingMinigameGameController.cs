...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiHackingMinigameGameController : gameuiWidgetGameController
	{
		...
		private CBool _deviceMode;
		private CBool _isAlternativeVariant;
		private inkWidgetReference _helpInputHintRef;
		...
		{
			get => GetProperty(ref _deviceMode);
		...
		{
			get => GetProperty(ref _isAlternativeVariant);
			set => SetProperty(ref _isAlternativeVariant, value);
		}
		...
		{
			get => GetProperty(ref _helpInputHintRef);
			set => SetProperty(ref _helpInputHintRef, value);
		}
