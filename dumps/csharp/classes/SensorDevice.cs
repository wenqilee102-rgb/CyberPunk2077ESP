...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class SensorDevice : ExplosiveDevice
	{
		...
		private CBool _keepHostilityTowardsPlayerHostiles;
		private CBool _hostileUpdateTowardsPlayerHostilesDelayed;
		...
		{
			get => GetProperty(ref _keepHostilityTowardsPlayerHostiles);
			set => SetProperty(ref _keepHostilityTowardsPlayerHostiles, value);
		}
		...
		{
			get => GetProperty(ref _hostileUpdateTowardsPlayerHostilesDelayed);
			set => SetProperty(ref _hostileUpdateTowardsPlayerHostilesDelayed, value);
		}
