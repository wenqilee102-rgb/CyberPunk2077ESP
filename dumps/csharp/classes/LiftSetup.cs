...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class LiftSetup : CVariable
	{
		...
		private CName _movingCurve;
		private EffectFiringData _extraFX;
		private CBool _useExtraVerification;
		private CFloat _errorMargin;
		...
		{
			get => GetProperty(ref _movingCurve);
			set => SetProperty(ref _movingCurve, value);
		}
		...
		{
			get => GetProperty(ref _extraFX);
			set => SetProperty(ref _extraFX, value);
		}
		...
		{
			get => GetProperty(ref _useExtraVerification);
			set => SetProperty(ref _useExtraVerification, value);
		}
		...
		{
			get => GetProperty(ref _errorMargin);
			set => SetProperty(ref _errorMargin, value);
		}
