...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class GameplayRoleComponent : gameScriptableComponent
	{
		...
		private CEnum<EMappinVisualState> _forcedMappinVisualState;
		...
		private CArray<CEnum<gamedataMappinVariant>> _enabledMinimapMappins;
		...
		{
			get => GetProperty(ref _forcedMappinVisualState);
			set => SetProperty(ref _forcedMappinVisualState, value);
		}
		...
		{
			get => GetProperty(ref _enabledMinimapMappins);
			set => SetProperty(ref _enabledMinimapMappins, value);
		}
