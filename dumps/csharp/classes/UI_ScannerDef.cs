...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class UI_ScannerDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Bool _scannerChangeTargetTooltipVisibility;
		...
		private gamebbScriptID_Variant _scannerActiveTab;
		private gamebbScriptID_Bool _twintoneAvailable;
		private gamebbScriptID_Bool _twintoneApplyAvailable;
		private gamebbScriptID_Bool _twintoneNoModelAvailable;
		...
		{
			get => GetProperty(ref _scannerChangeTargetTooltipVisibility);
			set => SetProperty(ref _scannerChangeTargetTooltipVisibility, value);
		}
		...
		{
			get => GetProperty(ref _scannerActiveTab);
			set => SetProperty(ref _scannerActiveTab, value);
		}
