...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TakeOverControlSystem : gameScriptableSystem
	{
		...
		private entEntityID _takeControlSourceID;
		...
		private CBool _isReleaseOnHitLocked;
		...
		private wCHandle<gameObject> _sniperNestObject;
		private CFloat _timestampLastTCS;
		...
		{
			get => GetProperty(ref _takeControlSourceID);
			set => SetProperty(ref _takeControlSourceID, value);
		}
		...
		{
			get => GetProperty(ref _isReleaseOnHitLocked);
			set => SetProperty(ref _isReleaseOnHitLocked, value);
		}
		...
		public wCHandle<gameObject> SniperNestObject
		{
			get => GetProperty(ref _sniperNestObject);
			set => SetProperty(ref _sniperNestObject, value);
		}
		...
		{
			get => GetProperty(ref _timestampLastTCS);
			set => SetProperty(ref _timestampLastTCS, value);
		}
