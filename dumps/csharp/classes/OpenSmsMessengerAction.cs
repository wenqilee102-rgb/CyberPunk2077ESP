...
{
	[REDMeta]
	public class OpenSmsMessengerAction : GenericNotificationBaseAction
	{
		...
		public OpenSmsMessengerAction(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
