...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIHumanComponent : AICAgent
	{
		...
		private wCHandle<gameIBlackboard> _prereqsBlackboard;
		...
		private entEntityID _lastReservedSeatVehicle;
		private CBool _assignedVehicleStuck;
		...
		public wCHandle<gameIBlackboard> PrereqsBlackboard
		{
			get => GetProperty(ref _prereqsBlackboard);
			set => SetProperty(ref _prereqsBlackboard, value);
		}
		...
		{
			get => GetProperty(ref _lastReservedSeatVehicle);
			set => SetProperty(ref _lastReservedSeatVehicle, value);
		}
		...
		{
			get => GetProperty(ref _assignedVehicleStuck);
			set => SetProperty(ref _assignedVehicleStuck, value);
		}
