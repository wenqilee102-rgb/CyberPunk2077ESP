...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class SetCustomShootPosition : AIbehaviortaskScript
	{
		...
		private Vector4 _shootPointPosition;
		private CArray<Vector4> _targetsPosition;
		...
		{
			get => GetProperty(ref _waypointTag);
		...
		{
			get => GetProperty(ref _shootPointPosition);
			set => SetProperty(ref _shootPointPosition, value);
		}
		...
		{
			get => GetProperty(ref _targetsPosition);
			set => SetProperty(ref _targetsPosition, value);
		}
