...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class PlayerDevelopmentData : IScriptable
	{
		...
		private CArray<SAttributeData> _attributesData;
		...
		private CBool _progressionBuildSetCompleted;
		...
		{
			get => GetProperty(ref _attributesData);
			set => SetProperty(ref _attributesData, value);
		}
		...
		{
			get => GetProperty(ref _progressionBuildSetCompleted);
			set => SetProperty(ref _progressionBuildSetCompleted, value);
		}
