...
{
	[REDMeta]
	public class RadialSubMenuPanelLogicController : PlayerStatsUIHolder
	{
		...
		private wCHandle<hubRadialStaticSelectorController> _menuSelectorCtrl;
		...
		public wCHandle<hubRadialStaticSelectorController> MenuSelectorCtrl
		{
		...
		public RadialSubMenuPanelLogicController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
