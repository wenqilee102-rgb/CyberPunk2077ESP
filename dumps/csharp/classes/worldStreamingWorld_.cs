...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class worldStreamingWorld_ : CResource
	{
		...
		private CArray<rRef<worldStreamingBlock>> _blockRefs;
		...
		[Ordinal(2)] 
		[RED("blockRefs")] 
		public CArray<rRef<worldStreamingBlock>> BlockRefs
		{
			get => GetProperty(ref _blockRefs);
			set => SetProperty(ref _blockRefs, value);
		}
