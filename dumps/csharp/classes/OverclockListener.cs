...
{
	[REDMeta]
	public class OverclockListener : gameScriptStatusEffectListener
	{
		...
		public OverclockListener(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
