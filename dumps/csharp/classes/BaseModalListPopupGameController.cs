...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class BaseModalListPopupGameController : gameuiWidgetGameController
	{
		...
		private CBool _canPlaySwitchAnimation;
		...
		private CHandle<inkanimProxy> _inoutTransitionAnimProxy;
		...
		{
			get => GetProperty(ref _canPlaySwitchAnimation);
			set => SetProperty(ref _canPlaySwitchAnimation, value);
		}
		...
		{
			get => GetProperty(ref _inoutTransitionAnimProxy);
			set => SetProperty(ref _inoutTransitionAnimProxy, value);
		}
