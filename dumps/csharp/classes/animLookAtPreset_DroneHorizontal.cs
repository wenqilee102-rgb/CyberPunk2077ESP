...
{
	[REDMeta]
	public class animLookAtPreset_DroneHorizontal : animLookAtPreset
	{
		...
		public animLookAtPreset_DroneHorizontal(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
