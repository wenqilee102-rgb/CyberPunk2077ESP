...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class BrowserController : inkWidgetLogicController
	{
		...
		private inkWidgetReference _spinnerContentRoot;
		...
		private wCHandle<inkAsyncSpawnRequest> _webPageSpawnRequest;
		...
		{
			get => GetProperty(ref _spinnerContentRoot);
			set => SetProperty(ref _spinnerContentRoot, value);
		}
		...
		public wCHandle<inkAsyncSpawnRequest> WebPageSpawnRequest
		{
			get => GetProperty(ref _webPageSpawnRequest);
			set => SetProperty(ref _webPageSpawnRequest, value);
		}
