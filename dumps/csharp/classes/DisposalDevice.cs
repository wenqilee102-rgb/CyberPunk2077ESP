...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class DisposalDevice : InteractiveDevice
	{
		...
		private CFloat _distractionSoundDuration;
		private CFloat _workspotDuration;
		private CHandle<redCallbackObject> _onReplacerChangedCallback;
		...
		{
			get => GetProperty(ref _distractionSoundDuration);
			set => SetProperty(ref _distractionSoundDuration, value);
		}
		...
		{
			get => GetProperty(ref _onReplacerChangedCallback);
			set => SetProperty(ref _onReplacerChangedCallback, value);
		}
