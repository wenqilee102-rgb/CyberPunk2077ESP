...
{
	[REDMeta]
	public class vehicleCinematicCameraShotEffect_VectorDamper : vehicleTimedCinematicCameraShotEffect
	{
		...
		public vehicleCinematicCameraShotEffect_VectorDamper(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
