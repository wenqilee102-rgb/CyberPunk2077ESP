...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class DistantFogAreaSettings : IAreaSettings
	{
		...
		private curveData<CFloat> _skyAltitudeBegin;
		private curveData<CFloat> _skyAltitudeEnd;
		private curveData<CFloat> _skyOpacity;
		...
		public curveData<CFloat> SkyAltitudeBegin
		{
			get => GetProperty(ref _skyAltitudeBegin);
			set => SetProperty(ref _skyAltitudeBegin, value);
		}

		[Ordinal(18)] 
		[RED("skyAltitudeEnd")] 
		public curveData<CFloat> SkyAltitudeEnd
		{
			get => GetProperty(ref _skyAltitudeEnd);
			set => SetProperty(ref _skyAltitudeEnd, value);
		}

		[Ordinal(19)] 
		[RED("skyOpacity")] 
		public curveData<CFloat> SkyOpacity
		{
			get => GetProperty(ref _skyOpacity);
			set => SetProperty(ref _skyOpacity, value);
		}
