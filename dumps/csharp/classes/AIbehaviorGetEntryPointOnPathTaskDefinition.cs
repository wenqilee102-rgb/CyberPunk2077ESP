...
{
	[REDMeta]
	public class AIbehaviorGetEntryPointOnPathTaskDefinition : AIbehaviorTaskDefinition
	{
		...
		public AIbehaviorGetEntryPointOnPathTaskDefinition(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
