...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIbehaviorFindClosestPointOnTrafficPathTaskDefinition : AIbehaviorTaskDefinition
	{
		...
		private CHandle<AIArgumentMapping> _useThreatPosAsAvoidedPos;
		...
		{
			get => GetProperty(ref _useThreatPosAsAvoidedPos);
			set => SetProperty(ref _useThreatPosAsAvoidedPos, value);
		}
