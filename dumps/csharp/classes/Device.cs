...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	{
		private CHandle<ScriptableDeviceComponent> _controller;
		...
		private CBool _cameraZoomActive;
		...
		private gameDelayID _advanceInteractionStateResolveDelayID;
		...
		private CBool _wasEngineeringSkillcheckTriggered;
		...
		{
			get => GetProperty(ref _cameraZoomActive);
			set => SetProperty(ref _cameraZoomActive, value);
		}
		...
		{
			get => GetProperty(ref _advanceInteractionStateResolveDelayID);
			set => SetProperty(ref _advanceInteractionStateResolveDelayID, value);
		}
		...
		{
			get => GetProperty(ref _wasEngineeringSkillcheckTriggered);
			set => SetProperty(ref _wasEngineeringSkillcheckTriggered, value);
		}
