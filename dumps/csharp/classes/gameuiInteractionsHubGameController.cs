...
{
	[REDMeta]
	public class gameuiInteractionsHubGameController : gameuiHUDGameController
	{
		...
		private inkWidgetReference _tooltipsAnchorPoint;
		...
		{
			get => GetProperty(ref _tooltipsAnchorPoint);
			set => SetProperty(ref _tooltipsAnchorPoint, value);
		}
		...
		public gameuiInteractionsHubGameController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
