...
{
	[REDMeta]
	public class MenuScenario_RadialHubMenu : MenuScenario_BaseMenu
	{
		private wCHandle<HubMenuInitData> _hubMenuInitData;
		private wCHandle<inkMenusState> _currentState;
		private CBool _combatRestriction;
		...
		{
			get => GetProperty(ref _combatRestriction);
			set => SetProperty(ref _combatRestriction, value);
		}
		...
		public MenuScenario_RadialHubMenu(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
