...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkSaveMetadataInfo : IScriptable
	{
		...
		private CEnum<inkSaveStatus> _saveStatus;
		...
		private CArray<CName> _additionalContentIds;
		...
		{
			get => GetProperty(ref _saveStatus);
		...
		{
			get => GetProperty(ref _additionalContentIds);
			set => SetProperty(ref _additionalContentIds, value);
		}
