...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class ChatterLineLogicController : BaseSubtitleLineLogicController
	{
		...
		private CFloat _bubbleMinDistance;
		private CBool _limitSubtitlesDistance;
		private CBool _isOverHead;
		...
		{
			get => GetProperty(ref _bubbleMinDistance);
			set => SetProperty(ref _bubbleMinDistance, value);
		}
		...
		{
			get => GetProperty(ref _isOverHead);
			set => SetProperty(ref _isOverHead, value);
		}
