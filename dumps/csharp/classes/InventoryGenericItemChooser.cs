...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class InventoryGenericItemChooser : inkWidgetLogicController
	{
		...
		private inkCompoundWidgetReference _transmogCtrlsContainer;
		private wCHandle<TransmogButtonView> _transmogIndicatorCtrl;
		private wCHandle<inkWidget> _transmogIndicator;
		...
		{
			get => GetProperty(ref _transmogCtrlsContainer);
			set => SetProperty(ref _transmogCtrlsContainer, value);
		}

		[Ordinal(15)] 
		[RED("transmogIndicatorCtrl")] 
		public wCHandle<TransmogButtonView> TransmogIndicatorCtrl
		{
			get => GetProperty(ref _transmogIndicatorCtrl);
			set => SetProperty(ref _transmogIndicatorCtrl, value);
		}

		[Ordinal(16)] 
		[RED("transmogIndicator")] 
		public wCHandle<inkWidget> TransmogIndicator
		{
			get => GetProperty(ref _transmogIndicator);
			set => SetProperty(ref _transmogIndicator, value);
		}
