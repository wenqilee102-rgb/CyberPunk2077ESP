...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiBaseWorldMapMappinController : gameuiInteractionMappinController
	{
		...
		private CBool _resetStateWhenUntracked;
		private CHandle<inkanimProxy> _isNewAnim;
		private CHandle<inkanimProxy> _fadeAnim;
		private CHandle<inkanimProxy> _selectAnim;
		private CFloat _fadeInOutDelay;
		...
		{
			get => GetProperty(ref _resetStateWhenUntracked);
			set => SetProperty(ref _resetStateWhenUntracked, value);
		}
		...
		{
			get => GetProperty(ref _isNewAnim);
			set => SetProperty(ref _isNewAnim, value);
		}
		...
		{
			get => GetProperty(ref _fadeInOutDelay);
			set => SetProperty(ref _fadeInOutDelay, value);
		}
