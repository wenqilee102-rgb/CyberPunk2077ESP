...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TarotMainGameController : gameuiMenuGameController
	{
		...
		private CInt32 _baseCards;
		private CInt32 _ep1Cards;
		...
		{
			get => GetProperty(ref _baseCards);
			set => SetProperty(ref _baseCards, value);
		}
		...
		{
			get => GetProperty(ref _ep1Cards);
			set => SetProperty(ref _ep1Cards, value);
		}
