...
{
	[REDMeta]
	public class gameEffectAction_NewEffect_SpreadingEffect : gameEffectPostAction
	{
		...
		public gameEffectAction_NewEffect_SpreadingEffect(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
