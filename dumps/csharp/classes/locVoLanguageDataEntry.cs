...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class locVoLanguageDataEntry : CVariable
	{
		...
		private raRef<JsonResource> _lengthMapReport;
		...
		[Ordinal(2)] 
		[RED("lengthMapReport")] 
		public raRef<JsonResource> LengthMapReport
		{
			get => GetProperty(ref _lengthMapReport);
			set => SetProperty(ref _lengthMapReport, value);
		}
