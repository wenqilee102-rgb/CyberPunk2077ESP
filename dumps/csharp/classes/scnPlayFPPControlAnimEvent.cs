...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class scnPlayFPPControlAnimEvent : scnPlayAnimEvent
	{
		...
		private CBool _enableWorldSpaceSmoothing;
		private CBool _isSceneCarrying;
		...
		{
			get => GetProperty(ref _enableWorldSpaceSmoothing);
			set => SetProperty(ref _enableWorldSpaceSmoothing, value);
		}
		...
		{
			get => GetProperty(ref _isSceneCarrying);
			set => SetProperty(ref _isSceneCarrying, value);
		}
