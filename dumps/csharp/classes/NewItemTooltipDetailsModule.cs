...
{
	[REDMeta]
	public class NewItemTooltipDetailsModule : NewItemTooltipModuleController
	{
		...
		private inkTextWidgetReference _dedicatedModsText;
		...
		{
			get => GetProperty(ref _dedicatedModsText);
			set => SetProperty(ref _dedicatedModsText, value);
		}
		...
		public NewItemTooltipDetailsModule(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
