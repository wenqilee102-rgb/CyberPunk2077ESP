...
{
	[REDMeta]
	public class AIbehaviorDriveToPointAutonomousAutodriveTreeNodeDefinition : AIbehaviorDriveTreeNodeDefinition
	{
		...
		public AIbehaviorDriveToPointAutonomousAutodriveTreeNodeDefinition(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
