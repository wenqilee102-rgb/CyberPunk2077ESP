...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class CMesh_ : resStreamedResource
	{
		...
		private CBool _useRayTracingShadowLODBias;
		private CBool _castsRayTracedShadowsFromOriginalGeometry;
		private CBool _isShadowMesh;
		private CBool _isPlayerShadowMesh;
		...
		{
			get => GetProperty(ref _useRayTracingShadowLODBias);
			set => SetProperty(ref _useRayTracingShadowLODBias, value);
		}
		...
		{
			get => GetProperty(ref _castsRayTracedShadowsFromOriginalGeometry);
			set => SetProperty(ref _castsRayTracedShadowsFromOriginalGeometry, value);
		}
		...
		{
			get => GetProperty(ref _isShadowMesh);
			set => SetProperty(ref _isShadowMesh, value);
		}
		...
		{
			get => GetProperty(ref _isPlayerShadowMesh);
			set => SetProperty(ref _isPlayerShadowMesh, value);
		}
