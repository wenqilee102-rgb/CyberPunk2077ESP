...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class questSpawnPlayerVehicle_NodeType : questIVehicleManagerNodeType
	{
		...
		private CBool _despawnAllEnabledVehicles;
		private CBool _retryUntilStubCreated;
		...
		{
			get => GetProperty(ref _despawnAllEnabledVehicles);
			set => SetProperty(ref _despawnAllEnabledVehicles, value);
		}
		...
		{
			get => GetProperty(ref _retryUntilStubCreated);
			set => SetProperty(ref _retryUntilStubCreated, value);
		}
