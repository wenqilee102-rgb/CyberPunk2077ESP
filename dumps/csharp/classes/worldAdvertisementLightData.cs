...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class worldAdvertisementLightData : CVariable
	{
		...
		private CEnum<rendRayTracedShadowsPlatform> _rayTracedShadowsPlatform;
		private CFloat _rayTracingLightSourceRadius;
		private CFloat _rayTracingContactShadowRange;
		...
		private CEnum<rendEPathTracingLightUsage> _pathTracingLightUsage;
		private CBool _pathTracingOverrideScaleGI;
		private CFloat _rtxdiShadowStartingDistance;
		...
		{
			get => GetProperty(ref _rayTracedShadowsPlatform);
			set => SetProperty(ref _rayTracedShadowsPlatform, value);
		}
		...
		{
			get => GetProperty(ref _rayTracingLightSourceRadius);
			set => SetProperty(ref _rayTracingLightSourceRadius, value);
		}
		...
		{
			get => GetProperty(ref _rayTracingContactShadowRange);
			set => SetProperty(ref _rayTracingContactShadowRange, value);
		}
		...
		{
			get => GetProperty(ref _pathTracingLightUsage);
			set => SetProperty(ref _pathTracingLightUsage, value);
		}
		...
		{
			get => GetProperty(ref _pathTracingOverrideScaleGI);
			set => SetProperty(ref _pathTracingOverrideScaleGI, value);
		}
		...
		{
			get => GetProperty(ref _rtxdiShadowStartingDistance);
			set => SetProperty(ref _rtxdiShadowStartingDistance, value);
		}
