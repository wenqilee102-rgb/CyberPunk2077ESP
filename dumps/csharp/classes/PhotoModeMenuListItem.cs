...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class PhotoModeMenuListItem : inkListItemController
	{
		...
		private inkWidgetReference _hueBarRef;
		private inkTextWidgetReference _counterLabelRef;
		private inkTextWidgetReference _leftLabelRef;
		...
		private inkWidgetReference _hueSliderRootWidgetRef;
		...
		private inkWidgetReference _hueSlidingAreaRef;
		private inkWidgetReference _colorSelectorUpFGRef;
		private inkWidgetReference _colorSelectorUpBGRef;
		private inkWidgetReference _colorSelectorDownFGRef;
		private inkWidgetReference _colorSelectorDownBGRef;
		private inkWidgetReference _hueBackgroundRef;
		private inkWidgetReference _saturationBackgroundRef;
		private inkWidgetReference _saturationColorRef;
		private inkWidgetReference _luminosityBackgroundRef;
		...
		private wCHandle<inkSliderController> _hueBar;
		...
		[Ordinal(20)] 
		[RED("HueBarRef")] 
		public inkWidgetReference HueBarRef
		{
			get => GetProperty(ref _hueBarRef);
			set => SetProperty(ref _hueBarRef, value);
		}
		...
		[Ordinal(22)] 
		[RED("LeftLabelRef")] 
		public inkTextWidgetReference LeftLabelRef
		{
			get => GetProperty(ref _leftLabelRef);
			set => SetProperty(ref _leftLabelRef, value);
		}
		...
		[Ordinal(35)] 
		[RED("HueSliderRootWidgetRef")] 
		public inkWidgetReference HueSliderRootWidgetRef
		{
			get => GetProperty(ref _hueSliderRootWidgetRef);
			set => SetProperty(ref _hueSliderRootWidgetRef, value);
		}
		...
		[Ordinal(39)] 
		[RED("HueSlidingAreaRef")] 
		public inkWidgetReference HueSlidingAreaRef
		{
			get => GetProperty(ref _hueSlidingAreaRef);
			set => SetProperty(ref _hueSlidingAreaRef, value);
		}

		[Ordinal(40)] 
		[RED("ColorSelectorUpFGRef")] 
		public inkWidgetReference ColorSelectorUpFGRef
		{
			get => GetProperty(ref _colorSelectorUpFGRef);
			set => SetProperty(ref _colorSelectorUpFGRef, value);
		}

		[Ordinal(41)] 
		[RED("ColorSelectorUpBGRef")] 
		public inkWidgetReference ColorSelectorUpBGRef
		{
			get => GetProperty(ref _colorSelectorUpBGRef);
			set => SetProperty(ref _colorSelectorUpBGRef, value);
		}

		[Ordinal(42)] 
		[RED("ColorSelectorDownFGRef")] 
		public inkWidgetReference ColorSelectorDownFGRef
		{
			get => GetProperty(ref _colorSelectorDownFGRef);
			set => SetProperty(ref _colorSelectorDownFGRef, value);
		}

		[Ordinal(43)] 
		[RED("ColorSelectorDownBGRef")] 
		public inkWidgetReference ColorSelectorDownBGRef
		{
			get => GetProperty(ref _colorSelectorDownBGRef);
			set => SetProperty(ref _colorSelectorDownBGRef, value);
		}

		[Ordinal(44)] 
		[RED("HueBackgroundRef")] 
		public inkWidgetReference HueBackgroundRef
		{
			get => GetProperty(ref _hueBackgroundRef);
			set => SetProperty(ref _hueBackgroundRef, value);
		}

		[Ordinal(45)] 
		[RED("SaturationBackgroundRef")] 
		public inkWidgetReference SaturationBackgroundRef
		{
			get => GetProperty(ref _saturationBackgroundRef);
			set => SetProperty(ref _saturationBackgroundRef, value);
		}

		[Ordinal(46)] 
		[RED("SaturationColorRef")] 
		public inkWidgetReference SaturationColorRef
		{
			get => GetProperty(ref _saturationColorRef);
			set => SetProperty(ref _saturationColorRef, value);
		}

		[Ordinal(47)] 
		[RED("LuminosityBackgroundRef")] 
		public inkWidgetReference LuminosityBackgroundRef
		{
			get => GetProperty(ref _luminosityBackgroundRef);
			set => SetProperty(ref _luminosityBackgroundRef, value);
		}
		...
		[Ordinal(53)] 
		[RED("HueBar")] 
		public wCHandle<inkSliderController> HueBar
		{
			get => GetProperty(ref _hueBar);
			set => SetProperty(ref _hueBar, value);
		}
		...
		[Ordinal(59)] 
		[RED("SliderDisplayType")] 
		public CUInt32 SliderDisplayType
		{
			get => GetProperty(ref _sliderDisplayType);
			set => SetProperty(ref _sliderDisplayType, value);
		}
		...
		{
			get => GetProperty(ref _doApply);
			set => SetProperty(ref _doApply, value);
		}
