...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class audioDirectorSystemSettings : audioAudioMetadata
	{
		...
		private CFloat _playerBrakeEventCooldown;
		private CFloat _trafficSpeedRC;
		private CFloat _trafficAccelerationRC;
		private CFloat _trafficRpmRC;
		private CFloat _trafficSlipRatioSkidThreshold;
		private CFloat _trafficHornSingleVehicleCooldown;
		private CFloat _trafficHornAllVehiclesCooldown;
		private CFloat _trafficHornMaxDistanceRangeToPlayer;
		...
		{
			get => GetProperty(ref _playerBrakeEventCooldown);
			set => SetProperty(ref _playerBrakeEventCooldown, value);
		}
		...
		{
			get => GetProperty(ref _trafficSlipRatioSkidThreshold);
			set => SetProperty(ref _trafficSlipRatioSkidThreshold, value);
		}
		...
		{
			get => GetProperty(ref _trafficHornSingleVehicleCooldown);
			set => SetProperty(ref _trafficHornSingleVehicleCooldown, value);
		}
		...
		{
			get => GetProperty(ref _trafficHornAllVehiclesCooldown);
			set => SetProperty(ref _trafficHornAllVehiclesCooldown, value);
		}
		...
		{
			get => GetProperty(ref _trafficHornMaxDistanceRangeToPlayer);
			set => SetProperty(ref _trafficHornMaxDistanceRangeToPlayer, value);
		}
