...
{
	[REDMeta]
	public class VehicleOverrideForceBrakes : ActionBool
	{
		...
		public VehicleOverrideForceBrakes(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
