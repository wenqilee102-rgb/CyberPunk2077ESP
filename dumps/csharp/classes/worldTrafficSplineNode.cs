...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class worldTrafficSplineNode : worldTrafficSourceNode
	{
		...
		private CBool _noAIDriving;
		private CBool _noAutodrive;
		...
		{
			get => GetProperty(ref _noAIDriving);
			set => SetProperty(ref _noAIDriving, value);
		}
		...
		{
			get => GetProperty(ref _noAutodrive);
			set => SetProperty(ref _noAutodrive, value);
		}
