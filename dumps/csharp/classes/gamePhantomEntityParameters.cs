...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gamePhantomEntityParameters : CVariable
	{
		...
		private CArray<CEnum<gamePhantomEntityState>> _phantomVisibleStates;
		...
		{
			get => GetProperty(ref _phantomVisibleStates);
			set => SetProperty(ref _phantomVisibleStates, value);
		}
