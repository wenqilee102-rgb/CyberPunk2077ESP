...
{
	[REDMeta]
	public class questAddDevelopmentPointsRequest : gamePlayerScriptableSystemRequest
	{
		...
		public questAddDevelopmentPointsRequest(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
