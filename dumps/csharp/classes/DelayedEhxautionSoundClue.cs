...
{
	[REDMeta]
	public class DelayedEhxautionSoundClue : gameDelaySystemScriptedDelayCallbackWrapper
	{
		...
		public DelayedEhxautionSoundClue(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
