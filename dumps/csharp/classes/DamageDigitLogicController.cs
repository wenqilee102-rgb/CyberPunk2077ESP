...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class DamageDigitLogicController : inkWidgetLogicController
	{
		...
		private inkTextWidgetReference _wheelShotWidget;
		private inkTextWidgetReference _executedWidget;
		...
		{
			get => GetProperty(ref _wheelShotWidget);
			set => SetProperty(ref _wheelShotWidget, value);
		}
		...
		{
			get => GetProperty(ref _executedWidget);
			set => SetProperty(ref _executedWidget, value);
		}
