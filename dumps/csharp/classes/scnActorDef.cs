...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class scnActorDef : CVariable
	{
		...
		private raRef<CResource> _holocallInitScn;
		...
		[Ordinal(18)] 
		[RED("holocallInitScn")] 
		public raRef<CResource> HolocallInitScn
		{
			get => GetProperty(ref _holocallInitScn);
			set => SetProperty(ref _holocallInitScn, value);
		}
