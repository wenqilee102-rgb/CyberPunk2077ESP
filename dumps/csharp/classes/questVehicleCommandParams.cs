...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class questVehicleCommandParams : questAICommandParams
	{
		...
		private CHandle<questvehiclePanicParams> _additionalParamsPanic;
		private CHandle<questvehicleChaseParams> _additionalParamsChase;
		...
		{
			get => GetProperty(ref _additionalParamsPanic);
			set => SetProperty(ref _additionalParamsPanic, value);
		}
		...
		{
			get => GetProperty(ref _additionalParamsChase);
			set => SetProperty(ref _additionalParamsChase, value);
		}
