...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class PuppetStateDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Bool _workspotAnimationInProgress;
		private gamebbScriptID_Bool _inAirAnimation;
		...
		{
			get => GetProperty(ref _workspotAnimationInProgress);
			set => SetProperty(ref _workspotAnimationInProgress, value);
		}
		...
		{
			get => GetProperty(ref _inAirAnimation);
			set => SetProperty(ref _inAirAnimation, value);
		}
