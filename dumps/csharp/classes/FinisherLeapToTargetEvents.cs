...
{
	[REDMeta]
	public class FinisherLeapToTargetEvents : FinisherTransition
	{
		...
		public FinisherLeapToTargetEvents(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
