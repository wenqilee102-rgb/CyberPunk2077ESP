...
{
	[REDMeta]
	public class InVehicleDrivePatrolDecorator : AIVehicleTaskAbstract
	{
		private CHandle<AIVehicleDrivePatrolCommand> _vehCommand;
		...
		public InVehicleDrivePatrolDecorator(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
