...
{
	[REDMeta]
	public class scneventsSpawnEntityEventFallbackData : CVariable
	{
		...
		public scneventsSpawnEntityEventFallbackData(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
