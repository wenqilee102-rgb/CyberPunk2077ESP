...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class scnChoiceNodeOption : CVariable
	{
		...
		private CName _caption;
		private CBool _blueline;
		private CBool _isFixedAsRead;
		...
		private CHandle<questIBaseCondition> _emphasisCondition;
		private CHandle<questIBaseCondition> _iconCondition;
		...
		{
			get => GetProperty(ref _isFixedAsRead);
			set => SetProperty(ref _isFixedAsRead, value);
		}
		...
		{
			get => GetProperty(ref _emphasisCondition);
			set => SetProperty(ref _emphasisCondition, value);
		}
		...
		{
			get => GetProperty(ref _iconCondition);
			set => SetProperty(ref _iconCondition, value);
		}
