...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class PlayerVisionModeControllerRefreshPolicy : CVariable
	{
		...
		private CEnum<PlayerVisionModeControllerRefreshPolicyEnum> _isBriefingActive;
		private CEnum<PlayerVisionModeControllerRefreshPolicyEnum> _twintoneOverrideShown;
		...
		{
			get => GetProperty(ref _twintoneOverrideShown);
			set => SetProperty(ref _twintoneOverrideShown, value);
		}
