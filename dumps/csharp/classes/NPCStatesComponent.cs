...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class NPCStatesComponent : gameAINetStateComponent
	{
		...
		private CFloat _keepRecentThreatAfterRelaxedDuration;
		...
		{
			get => GetProperty(ref _keepRecentThreatAfterRelaxedDuration);
			set => SetProperty(ref _keepRecentThreatAfterRelaxedDuration, value);
		}
