...
{
	[REDMeta]
	public class RadialMenuHubGameController : gameuiMenuGameController
	{
		private CHandle<MenuDataBuilder> _menusData;
		private wCHandle<inkMenuEventDispatcher> _menuEventDispatcher;
		private wCHandle<RadialMenuHubLogicController> _menuCtrl;
		private wCHandle<MetaQuestLogicController> _metaCtrl;
		private wCHandle<RadialSubMenuPanelLogicController> _subMenuCtrl;
		private wCHandle<RadialHubTimeSkipController> _timeCtrl;
		...
		[Ordinal(5)] 
		[RED("menuCtrl")] 
		public wCHandle<RadialMenuHubLogicController> MenuCtrl
		{
		...
		[Ordinal(7)] 
		[RED("subMenuCtrl")] 
		public wCHandle<RadialSubMenuPanelLogicController> SubMenuCtrl
		{
		...
		[Ordinal(8)] 
		[RED("timeCtrl")] 
		public wCHandle<RadialHubTimeSkipController> TimeCtrl
		{
		...
		public RadialMenuHubGameController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
