...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class scnChoiceNodeNsActorReminderParams : ISerializable
	{
		...
		private CBool _cutReminderEnabled;
		private CFloat _waitTimeToCutReminder;
		...
		{
			get => GetProperty(ref _cutReminderEnabled);
			set => SetProperty(ref _cutReminderEnabled, value);
		}
		...
		{
			get => GetProperty(ref _waitTimeToCutReminder);
			set => SetProperty(ref _waitTimeToCutReminder, value);
		}
