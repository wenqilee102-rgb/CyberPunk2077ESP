...
{
	[REDMeta]
	public class SetNPCSensesMainPreset : AIbehaviortaskScript
	{
		...
		public SetNPCSensesMainPreset(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
