...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameAttitudeAgentPS : gameComponentPS
	{
		...
		private CName _currentAttitudeGroupUnsavable;
		...
		{
			get => GetProperty(ref _currentAttitudeGroupUnsavable);
			set => SetProperty(ref _currentAttitudeGroupUnsavable, value);
		}
