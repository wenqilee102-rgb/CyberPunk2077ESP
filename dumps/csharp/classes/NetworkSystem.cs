...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class NetworkSystem : gameScriptableSystem
	{
		...
		private CArray<entEntityID> _networkRevealTargetsLastSession;
		...
		{
			get => GetProperty(ref _networkRevealTargetsLastSession);
			set => SetProperty(ref _networkRevealTargetsLastSession, value);
		}
