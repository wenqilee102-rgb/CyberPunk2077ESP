...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class UI_MapDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Variant _minimapLayerHighlightRequest;
		...
		{
			get => GetProperty(ref _minimapLayerHighlightRequest);
			set => SetProperty(ref _minimapLayerHighlightRequest, value);
		}
