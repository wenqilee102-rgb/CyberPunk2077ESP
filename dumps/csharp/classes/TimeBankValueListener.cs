...
{
	[REDMeta]
	public class TimeBankValueListener : gameScriptStatPoolsListener
	{
		...
		public TimeBankValueListener(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
