...
{
	[REDMeta]
	public class scneventsAttachPropToPerformerFallbackData : CVariable
	{
		private scnPerformerId _owner;
		private CStatic<scneventsAttachPropToPerformerCachedFallbackBone> _fallbackCachedBones;
		...
		public scneventsAttachPropToPerformerFallbackData(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
