...
{
	[REDMeta]
	public class NewItemTooltipWeaponBarsModule : NewItemTooltipModuleController
	{
		...
		public NewItemTooltipWeaponBarsModule(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
