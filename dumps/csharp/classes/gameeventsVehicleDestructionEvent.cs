...
{
	[REDMeta]
	public class gameeventsVehicleDestructionEvent : redEvent
	{
		...
		public gameeventsVehicleDestructionEvent(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
