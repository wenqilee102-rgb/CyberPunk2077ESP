...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gamesmartGunUIParameters : IScriptable
	{
		...
		private CArray<CName> _smartAudioEvents;
		private CArray<CFloat> _smartAudioEventsDelays;
		...
		{
			get => GetProperty(ref _smartAudioEvents);
			set => SetProperty(ref _smartAudioEvents, value);
		}
		...
		{
			get => GetProperty(ref _smartAudioEventsDelays);
			set => SetProperty(ref _smartAudioEventsDelays, value);
		}
