...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class EffectSharedDataDef : gamebbScriptDefinition
	{
		...
		private gamebbScriptID_Float _height;
		private gamebbScriptID_Float _initRange;
		private gamebbScriptID_Float _width;
		private gamebbScriptID_Vector4 _axisConstraints;
		...
		private gamebbScriptID_Vector4 _vfxOffset;
		private gamebbScriptID_Bool _disableVfx;
		private gamebbScriptID_Bool _enableImpulseFalloff;
		private gamebbScriptID_Float _impulseFalloffFactor;
		...
		private gamebbScriptID_Bool _inTPP;
		private gamebbScriptID_Float _tppScale;
		...
		private gamebbScriptID_Float _randRoll;
		private gamebbScriptID_Bool _ignoreMountedVehicleCollision;
		...
		{
			get => GetProperty(ref _initRange);
			set => SetProperty(ref _initRange, value);
		}
		...
		{
			get => GetProperty(ref _axisConstraints);
			set => SetProperty(ref _axisConstraints, value);
		}
		...
		{
			get => GetProperty(ref _tppScale);
			set => SetProperty(ref _tppScale, value);
		}
		...
		{
			get => GetProperty(ref _ignoreMountedVehicleCollision);
			set => SetProperty(ref _ignoreMountedVehicleCollision, value);
		}
