...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class hudCameraController : gameuiHUDGameController
	{
		...
		private inkHorizontalPanelWidgetReference _dateAndTimeHolder;
		private inkCanvasWidgetReference _recHolder;
		...
		private CBool _canActivateOverclock;
		...
		{
			get => GetProperty(ref _dateAndTimeHolder);
			set => SetProperty(ref _dateAndTimeHolder, value);
		}
		...
		{
			get => GetProperty(ref _recHolder);
			set => SetProperty(ref _recHolder, value);
		}
		...
		{
			get => GetProperty(ref _canActivateOverclock);
			set => SetProperty(ref _canActivateOverclock, value);
		}
