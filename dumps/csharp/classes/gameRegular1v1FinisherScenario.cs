...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameRegular1v1FinisherScenario : gameIFinisherScenario
	{
		...
		private CArray<gameFinisherSyncData> _syncData;
		...
		private CName _targetSlotNameToAttachAttackerWeaponLeft;
		...
		{
			get => GetProperty(ref _syncData);
			set => SetProperty(ref _syncData, value);
		}
		...
		{
			get => GetProperty(ref _targetSlotNameToAttachAttackerWeaponLeft);
			set => SetProperty(ref _targetSlotNameToAttachAttackerWeaponLeft, value);
		}
