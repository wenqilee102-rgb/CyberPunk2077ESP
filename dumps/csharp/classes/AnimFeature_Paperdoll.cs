...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AnimFeature_Paperdoll : animAnimFeature
	{
		...
		private CBool _characterCreation_Eyes;
		private CBool _characterCreation_Nose;
		private CBool _characterCreation_Lips;
		private CBool _characterCreation_Hair;
		private CBool _characterCreation_Jaw;
		...
		{
			get => GetProperty(ref _characterCreation_Eyes);
			set => SetProperty(ref _characterCreation_Eyes, value);
		}
		...
		{
			get => GetProperty(ref _characterCreation_Nose);
			set => SetProperty(ref _characterCreation_Nose, value);
		}
		...
		{
			get => GetProperty(ref _characterCreation_Lips);
			set => SetProperty(ref _characterCreation_Lips, value);
		}
		...
		{
			get => GetProperty(ref _characterCreation_Hair);
			set => SetProperty(ref _characterCreation_Hair, value);
		}
		...
		{
			get => GetProperty(ref _characterCreation_Jaw);
			set => SetProperty(ref _characterCreation_Jaw, value);
		}
