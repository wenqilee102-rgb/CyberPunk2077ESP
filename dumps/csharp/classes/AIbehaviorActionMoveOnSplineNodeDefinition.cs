...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIbehaviorActionMoveOnSplineNodeDefinition : AIbehaviorActionTreeNodeDefinition
	{
		...
		private CHandle<AIArgumentMapping> _splineRecalculation;
		...
		private CHandle<AIArgumentMapping> _disableFootIK;
		private CHandle<AIArgumentMapping> _allowCrowdOnPath;
		...
		{
			get => GetProperty(ref _splineRecalculation);
			set => SetProperty(ref _splineRecalculation, value);
		}
		...
		{
			get => GetProperty(ref _disableFootIK);
			set => SetProperty(ref _disableFootIK, value);
		}
		...
		{
			get => GetProperty(ref _allowCrowdOnPath);
			set => SetProperty(ref _allowCrowdOnPath, value);
		}
