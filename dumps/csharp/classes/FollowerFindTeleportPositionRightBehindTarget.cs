...
{
	[REDMeta]
	public class FollowerFindTeleportPositionRightBehindTarget : AIbehaviortaskScript
	{
		...
		public FollowerFindTeleportPositionRightBehindTarget(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
