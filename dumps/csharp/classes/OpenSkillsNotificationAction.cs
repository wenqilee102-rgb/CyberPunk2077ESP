...
{
	[REDMeta]
	public class OpenSkillsNotificationAction : GenericNotificationBaseAction
	{
		...
		public OpenSkillsNotificationAction(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
