...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkScreenProjectionData : CVariable
	{
		...
		private CBool _adjustWithDistance;
		private Vector3 _extraOffsetAtMaxDistance;
		...
		{
			get => GetProperty(ref _adjustWithDistance);
			set => SetProperty(ref _adjustWithDistance, value);
		}
		...
		{
			get => GetProperty(ref _extraOffsetAtMaxDistance);
			set => SetProperty(ref _extraOffsetAtMaxDistance, value);
		}
