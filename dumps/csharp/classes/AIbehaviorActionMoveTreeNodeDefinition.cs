...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIbehaviorActionMoveTreeNodeDefinition : AIbehaviorActionTreeNodeDefinition
	{
		...
		private CHandle<AIArgumentMapping> _ignoreCollisionsWhenCloseToTarget;
		private CHandle<AIArgumentMapping> _failWhenStoppedByCollision;
		...
		{
			get => GetProperty(ref _ignoreCollisionsWhenCloseToTarget);
			set => SetProperty(ref _ignoreCollisionsWhenCloseToTarget, value);
		}
		...
		{
			get => GetProperty(ref _failWhenStoppedByCollision);
			set => SetProperty(ref _failWhenStoppedByCollision, value);
		}
