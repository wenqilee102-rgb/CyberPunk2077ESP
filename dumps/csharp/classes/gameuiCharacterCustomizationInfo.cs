...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiCharacterCustomizationInfo : IScriptable
	{
		...
		private CArray<CEnum<gameuiCharacterCustomizationEditTag>> _editTags;
		...
		private CEnum<gamedataCharacterRandomizationCategory> _randomizeCategory;
		...
		{
			get => GetProperty(ref _randomizeCategory);
			set => SetProperty(ref _randomizeCategory, value);
		}
