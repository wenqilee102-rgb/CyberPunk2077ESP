...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiCreditsController : gameuiWidgetGameController
	{
		...
		private CBool _isPreVideoFinished;
		private CBool _isEp1CreditsImplementation;
		...
		{
			get => GetProperty(ref _isPreVideoFinished);
			set => SetProperty(ref _isPreVideoFinished, value);
		}
		...
		{
			get => GetProperty(ref _isEp1CreditsImplementation);
			set => SetProperty(ref _isEp1CreditsImplementation, value);
		}
