...
{
	[REDMeta]
	public class RemoveStatusEffectOnAttackEffector : ModifyAttackEffector
	{
		...
		public RemoveStatusEffectOnAttackEffector(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
