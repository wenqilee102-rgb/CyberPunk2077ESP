...
{
	[REDMeta]
	public class JudysDoor : InteractiveDevice
	{
		...
		private CFloat _forceOpeningAudioStimRange;
		private CFloat _openingAudioStimRange;
		...
		{
			get => GetProperty(ref _forceOpeningAudioStimRange);
			set => SetProperty(ref _forceOpeningAudioStimRange, value);
		}
		...
		{
			get => GetProperty(ref _openingAudioStimRange);
			set => SetProperty(ref _openingAudioStimRange, value);
		}
		...
		{
			get => GetProperty(ref _audioForceOpen);
			set => SetProperty(ref _audioForceOpen, value);
		}
		...
		public JudysDoor(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
