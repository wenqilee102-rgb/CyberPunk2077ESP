...
{
	[REDMeta]
	public class SystemStatusLogicController : inkWidgetLogicController
	{
		...
		private inkWidgetReference _statusBackground;
		private CHandle<inkanimProxy> _statusBackgroundProxy;
		...
		{
			get => GetProperty(ref _statusBackground);
		...
		{
			get => GetProperty(ref _statusBackgroundProxy);
			set => SetProperty(ref _statusBackgroundProxy, value);
		}
		...
		public SystemStatusLogicController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
