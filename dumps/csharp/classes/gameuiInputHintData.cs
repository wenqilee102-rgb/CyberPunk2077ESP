...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiInputHintData : CVariable
	{
		...
		private CEnum<inkInputHintKeyCombinationType> _inputHintKeyCombinationType;
		...
		{
			get => GetProperty(ref _inputHintKeyCombinationType);
			set => SetProperty(ref _inputHintKeyCombinationType, value);
		}
