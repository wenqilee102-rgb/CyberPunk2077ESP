...
{
	[REDMeta]
	public class IsNewPerkBoughtPrereq : gameIScriptablePrereq
	{
		...
		public IsNewPerkBoughtPrereq(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
