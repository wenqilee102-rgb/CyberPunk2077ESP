...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameEffectObjectProvider_SweepMelee_Box : gameEffectObjectProvider_SweepOverTime
	{
		...
		private CBool _playerUseCameraForObstructionChecks;
		...
		{
			get => GetProperty(ref _playerUseCameraForObstructionChecks);
			set => SetProperty(ref _playerUseCameraForObstructionChecks, value);
		}
