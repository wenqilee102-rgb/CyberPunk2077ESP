...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class inkHudWidgetSpawnEntry : CVariable
	{
		...
		private CBool _ignoreHudSafezones;
		private CBool _affectedByGlitchEffect;
		private CBool _affectedByBlackwallEffect;
		private CBool _spawnBeforeSlots;
		private CBool _ignoreHudScaleOverride;
		private CFloat _hudScalingInterpolationValue;
		private inkMargin _hudScalingMarginCorrection;
		...
		{
			get => GetProperty(ref _ignoreHudSafezones);
			set => SetProperty(ref _ignoreHudSafezones, value);
		}
		...
		{
			get => GetProperty(ref _affectedByBlackwallEffect);
			set => SetProperty(ref _affectedByBlackwallEffect, value);
		}
		...
		{
			get => GetProperty(ref _ignoreHudScaleOverride);
			set => SetProperty(ref _ignoreHudScaleOverride, value);
		}
		...
		{
			get => GetProperty(ref _hudScalingInterpolationValue);
			set => SetProperty(ref _hudScalingInterpolationValue, value);
		}
		...
		{
			get => GetProperty(ref _hudScalingMarginCorrection);
			set => SetProperty(ref _hudScalingMarginCorrection, value);
		}
