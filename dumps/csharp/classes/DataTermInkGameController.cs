...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class DataTermInkGameController : DeviceInkGameControllerBase
	{
		...
		private CHandle<redCallbackObject> _onToggleHologramListener;
		...
		{
			get => GetProperty(ref _onToggleHologramListener);
			set => SetProperty(ref _onToggleHologramListener, value);
		}
