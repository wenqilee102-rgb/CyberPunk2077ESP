...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AnimFeature_LeftHandCyberware : animAnimFeature
	{
		...
		private CFloat _chargeNormalized;
		private CBool _hasCWPerk;
		...
		{
			get => GetProperty(ref _chargeNormalized);
			set => SetProperty(ref _chargeNormalized, value);
		}
		...
		{
			get => GetProperty(ref _hasCWPerk);
			set => SetProperty(ref _hasCWPerk, value);
		}
