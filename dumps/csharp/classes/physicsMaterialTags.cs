...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class physicsMaterialTags : CVariable
	{
		...
		private CEnum<physicsMaterialTagProjectileRicochet> _projectileRicochet;
		...
		{
			get => GetProperty(ref _projectileRicochet);
			set => SetProperty(ref _projectileRicochet, value);
		}
