...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class WeakspotOnDestroyProperties : CVariable
	{
		...
		private CFloat _damageOwnerOnDestroy;
		private CName _customHitSFx;
		private CName _customDestroySFx;
		private TweakDBID _attackRecordID;
		private TweakDBID _statusEffectOnDestroyID;
		private CArray<gameWeakspotPhysicalDestructionComponent> _physicalDestructionComponents;
		...
		{
			get => GetProperty(ref _damageOwnerOnDestroy);
			set => SetProperty(ref _damageOwnerOnDestroy, value);
		}
		...
		{
			get => GetProperty(ref _customHitSFx);
			set => SetProperty(ref _customHitSFx, value);
		}
		...
		{
			get => GetProperty(ref _customDestroySFx);
			set => SetProperty(ref _customDestroySFx, value);
		}
		...
		{
			get => GetProperty(ref _physicalDestructionComponents);
			set => SetProperty(ref _physicalDestructionComponents, value);
		}
