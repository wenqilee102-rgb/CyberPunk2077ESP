...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class workWorkspotTree : ISerializable
	{
		...
		private CBool _propsPlaySyncAnim;
		...
		private CBool _initialCanUseExits;
		...
		{
			get => GetProperty(ref _propsPlaySyncAnim);
			set => SetProperty(ref _propsPlaySyncAnim, value);
		}
		...
		{
			get => GetProperty(ref _initialCanUseExits);
			set => SetProperty(ref _initialCanUseExits, value);
		}
