...
{
	[REDMeta]
	public class CommonItemsGridView : inkScriptableDataViewWrapper
	{
		...
		public CommonItemsGridView(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
