...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiInventoryGameController : gameuiMenuGameController
	{
		...
		private inkWidgetReference _cyberwareHolder;
		private inkCompoundWidgetReference _cyberdeckInventoryStatsContainer;
		...
		private inkWidgetReference _btnSets;
		...
		private CHandle<inkanimProxy> _itemModeProxy;
		private CHandle<inkanimProxy> _itemModeOutroProxy;
		private CHandle<inkanimProxy> _paperDollProxy;
		private CBool _targetPaperDollVisibility;
		private CBool _refreshUIRequested;
		...
		private wCHandle<CyberdeckInventoryStatsController> _cyberdeckInventoryStatsController;
		private CArray<CHandle<EquipmentAreaCategoryCreated>> _equipmentAreaCategoryEventQueue;
		private CArray<gameInventoryItemData> _cyberwareItems;
		private CArray<CHandle<EquipmentAreaCategory>> _equipmentAreaCategories;
		private CArray<CEnum<gamedataEquipmentArea>> _wardrobeOutfitAreas;
		private CInt32 _lastClothingSetIndex;
		private wCHandle<gameTelemetryTelemetrySystem> _telemetrySystem;
		private CHandle<CyberwareDisplayWrapper> _cyberwareScreenUserData;
		...
		{
			get => GetProperty(ref _cyberwareHolder);
			set => SetProperty(ref _cyberwareHolder, value);
		}
		...
		{
			get => GetProperty(ref _cyberdeckInventoryStatsContainer);
			set => SetProperty(ref _cyberdeckInventoryStatsContainer, value);
		}
		...
		{
			get => GetProperty(ref _btnSets);
			set => SetProperty(ref _btnSets, value);
		}
		...
		{
			get => GetProperty(ref _itemModeProxy);
			set => SetProperty(ref _itemModeProxy, value);
		}
		...
		{
			get => GetProperty(ref _itemModeOutroProxy);
			set => SetProperty(ref _itemModeOutroProxy, value);
		}
		...
		{
			get => GetProperty(ref _paperDollProxy);
			set => SetProperty(ref _paperDollProxy, value);
		}
		...
		{
			get => GetProperty(ref _targetPaperDollVisibility);
			set => SetProperty(ref _targetPaperDollVisibility, value);
		}
		...
		{
			get => GetProperty(ref _refreshUIRequested);
			set => SetProperty(ref _refreshUIRequested, value);
		}
		...
		public wCHandle<CyberdeckInventoryStatsController> CyberdeckInventoryStatsController
		{
			get => GetProperty(ref _cyberdeckInventoryStatsController);
			set => SetProperty(ref _cyberdeckInventoryStatsController, value);
		}
		...
		{
			get => GetProperty(ref _cyberwareItems);
			set => SetProperty(ref _cyberwareItems, value);
		}
		...
		{
			get => GetProperty(ref _wardrobeOutfitAreas);
			set => SetProperty(ref _wardrobeOutfitAreas, value);
		}
		...
		{
			get => GetProperty(ref _lastClothingSetIndex);
			set => SetProperty(ref _lastClothingSetIndex, value);
		}
		...
		{
			get => GetProperty(ref _cyberwareScreenUserData);
			set => SetProperty(ref _cyberwareScreenUserData, value);
		}
