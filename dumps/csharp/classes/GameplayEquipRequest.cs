...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class GameplayEquipRequest : gamePlayerScriptableSystemRequest
	{
		...
		private CFloat _extraQuality;
		private CArray<gameItemID> _partsToAdd;
		...
		{
			get => GetProperty(ref _extraQuality);
			set => SetProperty(ref _extraQuality, value);
		}
		...
		{
			get => GetProperty(ref _partsToAdd);
			set => SetProperty(ref _partsToAdd, value);
		}
