...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class FastTravelSystem : gameScriptableSystem
	{
		...
		private wCHandle<gamedataFastTravelSystem_Record> _fastTravelSystemRecord;
		...
		public wCHandle<gamedataFastTravelSystem_Record> FastTravelSystemRecord
		{
			get => GetProperty(ref _fastTravelSystemRecord);
			set => SetProperty(ref _fastTravelSystemRecord, value);
		}
