...
{
	[REDMeta]
	public class gameStopAutoDriveRequest : gameScriptableSystemRequest
	{
		...
		public gameStopAutoDriveRequest(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
