...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class TriggerContinuousAttackEffector : gameContinuousEffector
	{
		...
		private CEnum<gamedataEffectorTimeDilationDriver> _timeDilationDriver;
		...
		{
			get => GetProperty(ref _timeDilationDriver);
			set => SetProperty(ref _timeDilationDriver, value);
		}
