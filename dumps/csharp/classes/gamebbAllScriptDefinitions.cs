...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gamebbAllScriptDefinitions : IScriptable
	{
		...
		private CHandle<VehiclePurchaseDataDef> _vehiclePurchaseData;
		...
		private CHandle<AIPrereqsDataDef> _aIPrereqs;
		...
		private CHandle<UI_AutodriveDataDef> _uI_AutodriveData;
		...
		private CHandle<UI_HUDCountdownTimerDef> _uI_HUDCountdownTimer;
		...
		private CHandle<ElectricBoxBlackboardDef> _electricBoxBlackBoard;
		...
		private CHandle<NumericDisplayBlackboardDef> _numericDisplay;
		private CHandle<SniperNestDeviceBlackboardDef> _sniperNestDeviceBlackboard;
		...
		private CHandle<UI_AttributeBoughtDef> _uI_AttributeBought;
		...
		private CHandle<UI_InventoryDef> _uI_Inventory;
		...
		private CHandle<TokenUpgradedCyberwareBlackboardDef> _tokenUpgradedCyberwareBlackboard;
		...
		private CHandle<ChargedGrenadesBlackBoardDef> _chargedGrenadesBlackBoard;
		private CHandle<ChargedHealingBlackBoardDef> _chargedHealingBlackBoard;
		private CHandle<BlackwallAnimDef> _blackwallDeathAnim;
		...
		private CHandle<InputSchemesDef> _inputSchemes;
		private CHandle<PoliceChaseParamsDef> _policeChaseParams;
		...
		{
			get => GetProperty(ref _vehiclePurchaseData);
			set => SetProperty(ref _vehiclePurchaseData, value);
		}
		...
		{
			get => GetProperty(ref _aIPrereqs);
			set => SetProperty(ref _aIPrereqs, value);
		}
		...
		{
			get => GetProperty(ref _uI_AutodriveData);
			set => SetProperty(ref _uI_AutodriveData, value);
		}
		...
		{
			get => GetProperty(ref _uI_HUDCountdownTimer);
			set => SetProperty(ref _uI_HUDCountdownTimer, value);
		}
		...
		{
			get => GetProperty(ref _electricBoxBlackBoard);
			set => SetProperty(ref _electricBoxBlackBoard, value);
		}
		...
		{
			get => GetProperty(ref _numericDisplay);
			set => SetProperty(ref _numericDisplay, value);
		}
		...
		{
			get => GetProperty(ref _sniperNestDeviceBlackboard);
			set => SetProperty(ref _sniperNestDeviceBlackboard, value);
		}
		...
		{
			get => GetProperty(ref _uI_AttributeBought);
			set => SetProperty(ref _uI_AttributeBought, value);
		}
		...
		{
			get => GetProperty(ref _uI_Inventory);
			set => SetProperty(ref _uI_Inventory, value);
		}
		...
		{
			get => GetProperty(ref _tokenUpgradedCyberwareBlackboard);
			set => SetProperty(ref _tokenUpgradedCyberwareBlackboard, value);
		}
		...
		{
			get => GetProperty(ref _chargedGrenadesBlackBoard);
			set => SetProperty(ref _chargedGrenadesBlackBoard, value);
		}
		...
		{
			get => GetProperty(ref _chargedHealingBlackBoard);
			set => SetProperty(ref _chargedHealingBlackBoard, value);
		}
		...
		{
			get => GetProperty(ref _blackwallDeathAnim);
			set => SetProperty(ref _blackwallDeathAnim, value);
		}
		...
		{
			get => GetProperty(ref _inputSchemes);
			set => SetProperty(ref _inputSchemes, value);
		}
		...
		{
			get => GetProperty(ref _policeChaseParams);
			set => SetProperty(ref _policeChaseParams, value);
		}
