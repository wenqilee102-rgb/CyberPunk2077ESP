...
{
	[REDMeta]
	public class InventoryItemComparableTypesCache : IScriptable
	{
		...
		public InventoryItemComparableTypesCache(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
