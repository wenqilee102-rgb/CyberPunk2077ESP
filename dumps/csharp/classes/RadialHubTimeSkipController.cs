...
{
	[REDMeta]
	public class RadialHubTimeSkipController : inkWidgetLogicController
	{
		...
		public RadialHubTimeSkipController(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
