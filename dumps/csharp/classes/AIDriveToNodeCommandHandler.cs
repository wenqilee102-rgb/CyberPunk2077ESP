...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class AIDriveToNodeCommandHandler : AICommandHandlerBase
	{
		...
		private CHandle<AIArgumentMapping> _outIgnoreNoAIDrivingLanes;
		...
		{
			get => GetProperty(ref _outIgnoreNoAIDrivingLanes);
			set => SetProperty(ref _outIgnoreNoAIDrivingLanes, value);
		}
