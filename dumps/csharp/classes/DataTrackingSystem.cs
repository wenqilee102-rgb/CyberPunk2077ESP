...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	{
		private CArray<CEnum<gamedataAchievement>> _trackedAchievements;
		...
		private CBool _legPlusPlusHackDropped;
		...
		{
			get => GetProperty(ref _trackedAchievements);
			set => SetProperty(ref _trackedAchievements, value);
		}
		...
		{
			get => GetProperty(ref _legPlusPlusHackDropped);
			set => SetProperty(ref _legPlusPlusHackDropped, value);
		}
