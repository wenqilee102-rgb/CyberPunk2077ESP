...
{
	[REDMeta]
	public class CerberusRangedKillTask : AIbehaviortaskScript
	{
		...
		public CerberusRangedKillTask(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
