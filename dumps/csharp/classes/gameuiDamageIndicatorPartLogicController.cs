...
namespace WolvenKit.RED4.CR2W.Types
{
	...
	public class gameuiDamageIndicatorPartLogicController : gameuiBaseDirectionalIndicatorPartLogicController
	{
		...
		{
			get => GetProperty(ref _arrowBigWidget);
			set => SetProperty(ref _arrowBigWidget, value);
		}
		...
		{
			get => GetProperty(ref _revengeActive);
			set => SetProperty(ref _revengeActive, value);
		}
