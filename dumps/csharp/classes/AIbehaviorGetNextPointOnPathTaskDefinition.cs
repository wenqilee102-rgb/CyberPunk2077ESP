...
{
	[REDMeta]
	public class AIbehaviorGetNextPointOnPathTaskDefinition : AIbehaviorTaskDefinition
	{
		...
		public AIbehaviorGetNextPointOnPathTaskDefinition(IRed4EngineFile cr2w, CVariable parent, string name) : base(cr2w, parent, name) { }
	}
}
