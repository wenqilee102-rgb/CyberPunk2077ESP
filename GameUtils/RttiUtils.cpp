...
namespace GameUtils
{
    namespace RttiUtils
    {
        ...
        RED4ext::CBaseFunction* g_ProjectPointFunc = nullptr;
        RED4ext::CBaseFunction* g_GetEntityListFunc = nullptr;
        RED4ext::CBaseFunction* g_GetLocalPlayerMainGameObjectFunc = nullptr;
        ...
        bool InitializeSystems()
        {
            ...
            if (!g_GetLocalPlayerMainGameObjectFunc)
            {
                auto cpPlayerSystemClass = rtti->GetClass("cpPlayerSystem");
                if (Utils::IsValidPtr(cpPlayerSystemClass))
                {
                    g_GetLocalPlayerMainGameObjectFunc = cpPlayerSystemClass->GetFunction(RED4ext::CName("GetLocalPlayerMainGameObject"));
                    if (Utils::IsValidPtr(g_GetLocalPlayerMainGameObjectFunc))
                    {
                        DBG_INFO("cpPlayerSystem::GetLocalPlayerMainGameObject function: 0x%p", g_GetLocalPlayerMainGameObjectFunc);
                    }
                }
            }
